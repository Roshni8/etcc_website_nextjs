      ...
      <section className="main-container section">
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="overflow-hidden rounded-2xl border border-border bg-card p-6 shadow-card flex items-center justify-center">
            <img src="/assets/toroidal-custom.png" alt="Custom toroidal transformer with connector terminals" width={600} height={360} className="w-full max-h-[360px] object-contain" />
          </div>
          <div className="overflow-hidden rounded-2xl border border-border bg-card p-6 shadow-card flex items-center justify-center">
            <img src="/assets/toroidal-assorted.png" alt="Range of toroidal transformers and electromagnetic components" width={600} height={360} className="w-full max-h-[360px] object-contain" />
          </div>
        </div>
      </section>
